...
# Add a variable to load the file to a path.
...
# And beging tracking that candidate's voter count.
...
#4c: Beging tracking the county's vote count.
...
#6b: Initialize a variable to hold the ocunty's votes as they are retrieved from the county votes dictionary.
        county_vote = county_votes.get(county)

#6c: Print the county results to the terminal.
...
# Retrieve vote count and percentage
        ...
        candidate_results = f"{vote_percentage:.1f}% ({votes:})\n"

# print each candidate's vote count and percentage to the
# terminal
